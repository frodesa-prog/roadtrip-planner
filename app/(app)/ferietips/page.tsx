  ...
  return (
    <div className="h-full flex bg-slate-950">
      ...
      <div className="flex-1 flex flex-col min-w-0">
          ...
          {!activeSessionId ? (
            ...
            <div className="min-h-full flex items-center justify-center">
              <div className="text-center space-y-4">
                ...
                <button
                  onClick={() => createSession()}
                  className="flex items-center gap-2 mx-auto px-4 py-2 rounded-lg bg-amber-500 hover:bg-amber-400 text-white text-sm font-medium transition-colors"
                >
            ...
            /* Empty new session: welcome + suggestions */
        ...
        {/* Input area – only shown when a session is active */}
        {activeSessionId && (
