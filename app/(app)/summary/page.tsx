              ...
              {hotelName ? (
                confirmedHotelUrl ? (
                  ...
                  >
                    ...
                    {hotelAmenities?.washer    && <span title="Vaskemaskin"><WashingMachine className="w-2.5 h-2.5 flex-shrink-0 text-sky-400" /></span>}
                    {hotelAmenities?.kitchen   && <span title="Kjøkken"><ChefHat className="w-2.5 h-2.5 flex-shrink-0 text-orange-400" /></span>}
                    {hotelAmenities?.breakfast && <span title="Frokost inkludert"><Coffee className="w-2.5 h-2.5 flex-shrink-0 text-amber-500" /></span>}
